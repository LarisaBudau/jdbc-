...
public class MarketingCampaignDAO {
    ...
    //search by name - returneaza toate marketing campaign care includ in numele lor, numele date de utilizator
    //searchByNAme("Year") -> [New Year's Campaign, 2023 Year Compaign"]
    //!! folositi pentru implementare PrepearedStatement
    ...
    //search by date (before, after) - sa returneze toate marketing campaign care au start_date intre datele date de utiiizator
    //searchBetween(2022-12-01, 2022-12-31) - returneaza toate marketing campaigns care incep in decembrie 2022
    //!! folositi pentru implementare PrepearedStatement
    ...
    public List<MarketingCampaign> searchBetween(Date startDate, Date endDate) {
        ...
        try {
            ...
            //prepared statement, sa pun doar valoarea acolo, nu cu stringuri
